...
# filt_list = ['F1000W', 'F560W', 'F770W']
filt_list = ['F1130W']
basename = 'jw02391009001'
work_dir = '/astro/dust_kg/etarantino/JWST_PAHS_2391/sexa/miri_nov23'
...
shifts = [-0.21954867704299152, 0.007972056871008609]

# reference catalog
ref_path = '/astro/dust_kg/etarantino/JWST_PAHS_2391/sexa/'
ref_name = 'JWST2391_F1000W_catalog.ecsv'
...
for filter in filt_list:
    ...
    if align_short:
        ...
        if make_bkg:
            ...
            miri_asn_name = output_dir + f'/miri_{filter}_stage3_asn_fixed_wcs_skysub'   
