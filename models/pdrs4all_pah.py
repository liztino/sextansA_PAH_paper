...
for PDR_spec in PDR_spec_arr:
    ...
    spec_name = f'spec_orion_{PDR_spec}.ecsv'
    ...
    clipped = stats.sigma_clip(data = Flambda[ind].value, sigma = 50)
    ...
    savename = '{}_PDRs4ALL_{}_spec_confit_nolines.pdf'.format(filt_contam, PDR_spec)
    ...
    savepath = '/Users/etarantino/Documents/JWST_DATA_PAHS/analysis/models/plots/calc_PAH_contamination/{}_con_fit_tests_v4/'.format(filt_contam)
    savename = '{}_PDRs4ALL_{}_spec_consub_nolines.pdf'.format(filt_contam, PDR_spec)
    plt.savefig(savepath + savename)
...
final_table_name = '{}_PDRs4ALL_spec_PAH_contamination_v6_emission_line.txt'.format(filt_contam)
